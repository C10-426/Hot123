...
class __TwigTemplate_3ca2034c1a3e327d3541e3b6e0c9bd8bb2bd6c5907bf30692ec6904390b4b6db extends Twig_Template
{
    ...
    ";
        ...
        <div ng-controller=\"DelegateMobileMessagingSettingsController as delegateManagement\">
            <div piwik-field uicontrol=\"radio\" name=\"delegatedManagement\"
                 options=\"";
            // line 13
            echo \Piwik\piwik_escape_filter($this->env, twig_jsonencode_filter(($context["delegateManagementOptions"] ?? $this->getContext($context, "delegateManagementOptions"))), "html", null, true);
            echo "\"
                 full-width=\"true\"
            ...
            echo "\"
                 value=\"";
            // line 17
            if (($context["delegatedManagement"] ?? $this->getContext($context, "delegatedManagement"))) {
                echo "1";
            } else {
                echo "0";
            }
    ...
    ";
        // line 24
        if (($context["accountManagedByCurrentUser"] ?? $this->getContext($context, "accountManagedByCurrentUser"))) {
            // line 25
            echo "        <div piwik-content-block content-title=\"";
            ...
            ";
            // line 27
            if ((($context["isSuperUser"] ?? $this->getContext($context, "isSuperUser")) && ($context["delegatedManagement"] ?? $this->getContext($context, "delegatedManagement")))) {
                // line 28
                echo "                <p>";
            ...
            ";
            // line 31
            echo $context["macro"]->getmanageSmsApi(($context["credentialSupplied"] ?? $this->getContext($context, "credentialSupplied")), ($context["credentialError"] ?? $this->getContext($context, "credentialError")), ($context["creditLeft"] ?? $this->getContext($context, "creditLeft")), ($context["smsProviderOptions"] ?? $this->getContext($context, "smsProviderOptions")), ($context["smsProviders"] ?? $this->getContext($context, "smsProviders")), ($context["provider"] ?? $this->getContext($context, "provider")));
            echo "
        </div>
    ";
        }
    ...
    <div piwik-content-block content-title=\"";
        ...
        ";
                ...
                <div class=\"form-group row\">
                    <div class=\"col s12 m6\">
                        <div piwik-field uicontrol=\"select\" name=\"countryCodeSelect\"
                             value=\"";
            // line 60
            echo \Piwik\piwik_escape_filter($this->env, ($context["defaultCallingCode"] ?? $this->getContext($context, "defaultCallingCode")), "html", null, true);
            echo "\"
            ...
            echo "\"
                             options='";
            // line 64
            echo \Piwik\piwik_escape_filter($this->env, twig_jsonencode_filter(($context["countries"] ?? $this->getContext($context, "countries"))), "html", null, true);
            echo "'>
                        </div>
                    </div>
            ...
            echo "
                    ...
                    <div class=\"col s12 m6 form-help\">
                        ";
            // line 108
            echo \Piwik\piwik_escape_filter($this->env, ($context["strHelpAddPhone"] ?? $this->getContext($context, "strHelpAddPhone")), "html", null, true);
            echo "
                    </div>
                </div>
            ...
            $context['_seq'] = twig_ensure_traversable(($context["phoneNumbers"] ?? $this->getContext($context, "phoneNumbers")));
            $context['loop'] = array(
            ...
            echo "
                ";
            // line 156
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute(($context["ajax"] ?? $this->getContext($context, "ajax")), "errorDiv", array(0 => "invalidVerificationCodeAjaxError"), "method"), "html", null, true);
            echo "
...
{% endblock %}
", "@MobileMessaging/index.twig", "/home/leo/Document/Git/Hot123/hot123/public/piwik/plugins/MobileMessaging/templates/index.twig");
    }
}
