...
class __TwigTemplate_9ad953fa2a8eddc965e38e33dd1042f3a2d5659d197591232fda38035e3cd9ac extends Twig_Template
{
...
($context["reports"] ?? $this->getContext($context, "reports")))) {
            ...
            <td colspan='7'>
                ...
                ";
            // line 35
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array(call_user_func_array($this->env->getFilter('translate')->getCallable(), array("ScheduledReports_ThereIsNoReportToManage", ($context["siteName"] ?? $this->getContext($context, "siteName"))))));
            echo ".
                <br/><br/>
            </td>
        </tr>
...
", "@ScheduledReports/_listReports.twig", "/home/leo/Document/Git/Hot123/hot123/public/piwik/plugins/ScheduledReports/templates/_listReports.twig");
    }
}
