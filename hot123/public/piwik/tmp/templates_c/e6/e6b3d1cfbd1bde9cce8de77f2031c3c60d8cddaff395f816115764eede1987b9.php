...
class __TwigTemplate_54fb518023c05545bdb92fd9f963905cf4ca7d5df7c985fda054900401267419 extends Twig_Template
{
...
<div class=\"marketplace-max-width\" ng-controller=\"PiwikMarketplaceLicenseController as licenseController\">
    ...
    ";
            ...
            if (($context["isSuperUser"] ?? $this->getContext($context, "isSuperUser"))) {
                // line 52
                echo "            ";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Marketplace_PaidPluginsNoLicenseKeyIntro", "<a target='_blank' href='?module=Proxy&action=redirect&url=https://piwik.org/recommends/premium-plugins/'>", "</a>"));
                echo "
        ...
        ";
                ...
                // line 63
                echo "            ";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Marketplace_PaidPluginsNoLicenseKeyIntroNoSuperUserAccess", "<a target='_blank' href='?module=Proxy&action=redirect&url=https://piwik.org/recommends/premium-plugins/'>", "</a>"));
                echo "
        ";
            }
            // line 65
...
", "@Marketplace/licenseform.twig", "/home/leo/Document/Git/Hot123/hot123/public/piwik/plugins/Marketplace/templates/licenseform.twig");
    }
}
